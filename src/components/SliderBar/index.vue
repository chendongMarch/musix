<template>
  <div ref="bar-container" class="slider-bar-container" :style="containerStyle">
    ...
    <div ref="slide-block-1" class="slide-block" @panstart="webStartHandler" @panmove="webMoveHandler1" @touchstart="appStartHandler1" @touchend="appEndHandler" @horizontalpan="appHandler1" :prevent-move-event="preventMoveEvent" :style="blockStyle1">
      <div></div>
    </div>
    <div v-if="range" ref="slide-block-2" class="slide-block" @panstart="webStartHandler" @panmove="webMoveHandler2" @touchstart="appStartHandler2" @touchend="appEndHandler" @horizontalpan="appHandler2" :prevent-move-event="preventMoveEvent" :style="blockStyle2">
      <div></div>
    </div>
  </div>
</template>
