...
public class PageActivity extends AppCompatActivity {
    ...
    public void setNavigationTitle(Object params, ResultCallback<JSONObject> callback) {
        ...
        navigationBarBackgroundColor = eeuiJson.getString(item, "backgroundColor", (!mPageInfo.getStatusBarColor().equals("") ? mPageInfo.getStatusBarColor() : eeuiJson.getString(defaultStyles, "backgroundColor", "#2AA244")));
        ...
        if (TextUtils.isEmpty(titleColor)) {
            titleColor = navigationBarBackgroundColor.contentEquals("#2AA244") ? "#ffffff" : "#232323";
        }
        if (TextUtils.isEmpty(subtitleColor)) {
            subtitleColor = navigationBarBackgroundColor.contentEquals("#2AA244") ? "#ffffff" : "#232323";
        }
    ...
    public void setNavigationItems(Object params, String position, ResultCallback<JSONObject> callback) {
        ...
        for (int i = 0; i < buttonArray.size(); i++) {
            ...
            if (TextUtils.isEmpty(iconColor)) {
                iconColor = navigationBarBackgroundColor.contentEquals("#2AA244") ? "#ffffff" : "#232323";
            }
