...
- (void)setupUI
{
    ...
    _statusBar.backgroundColor = [[WXConvert UIColor:_statusBarColor?_statusBarColor : @"#2AA244"] colorWithAlphaComponent:alpha];
...
-(void)showErrorBox:(NSString *)errCode
{
    if (self.errorView == nil) {
        ...
        label1.textColor = [WXConvert UIColor:@"#2AA244"];
        ...
        #endif
        label3.textColor = [WXConvert UIColor:@"#2AA244"];
...
- (void)setNavigationTitle:(id) params callback:(WXModuleKeepAliveCallback) callback
{
    ...
    _navigationBarBarColor = item[@"backgroundColor"] ? [WXConvert NSString:item[@"backgroundColor"]] : (_statusBarColor ? _statusBarColor : (defaultStyles[@"backgroundColor"] ? [WXConvert NSString:defaultStyles[@"backgroundColor"]] : @"#2AA244"));
    ...
    if (titleColor.length == 0) {
        titleColor = [_navigationBarBarColor isEqualToString:@"#2AA244"] ? @"#ffffff" : @"#232323";
    }
    if (subtitleColor.length == 0) {
        subtitleColor = [_navigationBarBarColor isEqualToString:@"#2AA244"] ? @"#ffffff" : @"#232323";
    }
...
- (void)setNavigationItems:(id) params position:(NSString *)position callback:(WXModuleKeepAliveCallback) callback
{
    ...
    for (NSDictionary *item in buttonArray)
    {
        ...
        if (iconColor.length == 0) {
            iconColor = [_navigationBarBarColor isEqualToString:@"#2AA244"] ? @"#ffffff" : @"#232323";
        }
